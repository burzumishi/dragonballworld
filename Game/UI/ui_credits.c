...
static void UI_CreditMenu_Draw( void ) {
	...
	UI_DrawProportionalString( x, y, "Circlerun", UI_LEFT|UI_TINYFONT|UI_DROPSHADOW, color_white );
        ...
        y += 1.42 * PROP_HEIGHT * PROP_SMALL_SIZE_SCALE;
        UI_DrawProportionalString( x, y, "Dragon Ball World (Team)", UI_LEFT|UI_SMALLFONT|UI_DROPSHADOW, color_white );
        y += PROP_HEIGHT * PROP_SMALL_SIZE_SCALE;
        UI_DrawProportionalString( x, y, "BuRZuM-iSHi", UI_LEFT|UI_TINYFONT|UI_DROPSHADOW, color_white );}
